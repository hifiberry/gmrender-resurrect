...
static struct upnp_device_descriptor render_device = {
	.init_function          = upnp_renderer_init,
        ...
        .manufacturer_url       = "https://www.hifiberry.com",
        .model_description      = "HiFiBerry audio player",
        .model_name             = "HiFiBerryOS",
        .model_number           = GM_COMPILE_VERSION,
        .model_url              = "https://www.hifiberry.com",
        .serial_number          = "1",
        .udn                    = "uuid:GMediaRender-1_0-000-000-002",
        .upc                    = "",
        .presentation_url       = "https://www.hifiberry.com",
        .mime_filter            = NULL,
        .icons                  = renderer_icon,
